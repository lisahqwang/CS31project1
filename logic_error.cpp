...
//I changed the original code of (100.0 * democraticVotes) / totalVoters to having the denominator being democraticVotes, this would change most test case results in this variable 

   double pctDemoc = (100.0 * democraticVotes) / democraticVotes;
